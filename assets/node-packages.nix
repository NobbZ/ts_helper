...
let
  sources = {
    ...
    "phoenix-1.5.7" = {
      ...
      version = "1.5.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/phoenix/-/phoenix-1.5.7.tgz";
        sha512 = "RgVdTRsK5NpnUPkjPyLg9P8qQQvuDaUsazH06t+ARu9EnPryQ7asE76VDjVZ43fqjY/p8er6y6OQb17YViG47g==";
      };
    };
    "phoenix_html-2.14.2" = {
      name = "phoenix_html";
      ...
      version = "2.14.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/phoenix_html/-/phoenix_html-2.14.2.tgz";
        sha512 = "Ethq57+1Vhwj8i6RrFbkZIxOps+4yZV2hZsmMplSVgyvLbFBWN5D6KI5Y76ub7Q4d3nKdF+rQD8vPCuLAhtQsA==";
      };
    };
    "phoenix_live_view-0.15.1" = {
      ...
      version = "0.15.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/phoenix_live_view/-/phoenix_live_view-0.15.1.tgz";
        sha512 = "Bpy676aqVs31XfW/LWpSiOZfyVF+sU+Tc+XDpIdU6xjBZWygyeTn1NEf26Q1zlYVC1VH+H24RGm6U1UAm0olBQ==";
      };
    };
    "picomatch-2.2.2" = {
      name = "picomatch";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."phoenix-1.5.7"
      sources."phoenix_html-2.14.2"
      sources."phoenix_live_view-0.15.1"
